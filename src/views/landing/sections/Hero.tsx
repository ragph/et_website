import { Box, Container, Typography, Button, Grid, Chip, Avatar, AvatarGroup } from '@mui/material';
        ...
        <Grid container spacing={{ xs: 4, md: 3 }} alignItems="center">
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <AnimatedSection animation="fadeUp" duration={0.6} delay={0.1}>
              ...
              >
                Your unique global tourism partner for your memorable, exciting travels - providing you with great income and benefits for every destination!
              </Typography>
            </AnimatedSection>
